...
{
    public partial class frmCampMedicines : System.Web.UI.Page
    {
        ...
        void getMedicines()
        {
            using (MedicinesOperation medicinesOperation = new MedicinesOperation())
            {
                medicinesOperation.GetMedicines(gvMedicines);
            }
        }
