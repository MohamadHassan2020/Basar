<%@ Page Title="" Language="C#" MasterPageFile="~/Master/SiteAdmin.Master" AutoEventWireup="true" CodeBehind="frmPreparation.aspx.cs" Inherits="Basar.PreparationForm.frmPreparation " %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <link href="../fonts/glyphicons-halflings-regular.woff"></link>
    <link href="../fonts/glyphicons-halflings-regular.ttf"></link>
                        ...
                        <ContentTemplate>
                            <div class="form-horizontal">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <!--
                                            <span class="input-group-btn">
                                                <asp:LinkButton class="btn btn-default" ID="lbtnSearch" runat="server" OnClick="lbtnSearch_Click" CausesValidation="false">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <asp:DropDownList ID="ddlTeam" runat="server" CssClass="form-control" DataTextField="TeamDsecAr" DataValueField="TeamId">
                                    ...
                                    <div class="col-md-4">
                                        <asp:DropDownList ID="ddlSponosr" runat="server" CssClass="form-control" DataTextField="SponsorDsecAr" DataValueField="SponsorId"></asp:DropDownList>
                                    </div>
                                    <!---->
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <asp:Label runat="server" AssociatedControlID="txtPreparationRemark" CssClass="col-md-2 control-label label_red">ملاحظات</asp:Label>
                                    <div class="col-md-10">
                                        <asp:TextBox ID="txtPreparationRemark" runat="server" placeholder="ملاحظات" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-2">
                                        <asp:Button ID="btnSearch" runat="server" Text="بحث" CausesValidation="false" CssClass="btn btn-primary" OnClick="btnSearch_Click" />
                                    </div>
                                    <div class="col-md-2">
                                    ...
                                    <div class="col-md-4">
                                        <asp:Button ID="btnPrint" runat="server" Text="طباعة" CssClass="btn btn-primary" OnClick="btnPrint_Click" CausesValidation="false" />
                                        <asp:Button ID="btnPrintSponsor" runat="server" Text="طباعة الراعي" CssClass="btn btn-primary" OnClick="btnPrintSponsor_Click" CausesValidation="false" />
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:GridView ID="gvAnnualPlan" runat="server" AutoGenerateColumns="False" Width="98%" CssClass="table table-bordered table-hover" AllowPaging="True" OnRowCommand="gvAnnualPlan_RowCommand" OnDataBound="gvAnnualPlan_DataBound" EmptyDataText="لا يوجد مخيمات في البحث" OnPageIndexChanging="gvAnnualPlan_PageIndexChanging">
                                        <Columns>
                                            <asp:TemplateField>
                                                <HeaderTemplate>
