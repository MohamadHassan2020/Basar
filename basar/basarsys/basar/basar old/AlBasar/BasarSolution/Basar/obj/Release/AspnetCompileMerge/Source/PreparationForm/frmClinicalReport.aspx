...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-lg-10">
                        ...
                        <ContentTemplate>
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:Label runat="server" AssociatedControlID="txtTeamMemberCount" CssClass="col-md-2 control-label label_red">عدد الفريق</asp:Label>
                                    <div class="col-md-4">
                                        <asp:TextBox ID="txtTeamMemberCount" CssClass="form-control" MaxLength="3" placeholder="عدد الفريق" runat="server"></asp:TextBox>
                                    </div>
                                ...
                                <div class="form-group">
                                    <asp:Label runat="server" AssociatedControlID="txtCampVisitors" CssClass="col-md-2 control-label">زوار الفريق</asp:Label>
                                    <div class="col-md-8">
                                        <asp:TextBox ID="txtCampVisitors" CssClass="form-control" MaxLength="100" placeholder="زوار الفريق" runat="server"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <asp:Label runat="server" AssociatedControlID="txtCoverageMedia" CssClass="col-md-2 control-label">التغطية الإعلامية</asp:Label>
                                    <div class="col-md-8">
                                        <asp:TextBox ID="txtCoverageMedia" CssClass="form-control" MaxLength="100" placeholder="التغطية الإعلامية" runat="server"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <asp:Label runat="server" AssociatedControlID="txtCampLocation" CssClass="col-md-2 control-label">مكان المخيم</asp:Label>
                                    <div class="col-md-8">
                                        <asp:TextBox ID="txtCampLocation" CssClass="form-control" MaxLength="100" placeholder="مكان المخيم" runat="server"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <asp:Label runat="server" AssociatedControlID="txtCampReportNote" CssClass="col-md-2 control-label label_red">ملاحظات</asp:Label>
                                    <div class="col-md-8">
                                        <asp:TextBox ID="txtCampReportNote" runat="server" CssClass="form-control" placeholder="بيان المخيم" cols="20"  Rows="3" TextMode="MultiLine"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <asp:GridView ID="gvAxes" runat="server" AutoGenerateColumns="False" EmptyDataText="" CssClass="table table-bordered table-hover">
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtMaleAxes" runat="server" Text='<%# Bind("MaleAxes")  %>' onkeypress="return onlyNumbers(this);" MIN="0" TextMode="Number" CssClass="form-control male-value" Width="80px">  </asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtFemaleAxes" runat="server" MIN="0" Text='<%# Bind("FemaleAxes")  %>' onkeypress="return onlyNumbers(this);" TextMode="Number" CssClass="form-control female-value" Width="80px">  </asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblTotal" runat="server" MIN="0" Text='<%# Bind("AxesTotal")  %>' onkeypress="return onlyNumbers(this);" TextMode="Number" CssClass="control-label total-value" Width="60px">  </asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>
            ...
            <script src="../sysjs/clinical-report.js"></script>
            <script>
                $("[id$='txtTeamMemberCount']").on("keypress", function () {
                      return onlyNumbers($(this).val());
                });
            </script>
</asp:Content>
