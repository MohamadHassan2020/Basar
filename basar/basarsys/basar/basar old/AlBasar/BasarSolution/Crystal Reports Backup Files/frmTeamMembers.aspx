                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3 has-feedback">
                                        ...
                                        <cc1:CalendarExtender runat="server" BehaviorID="txtDateOfBirth_CalendarExtender" TargetControlID="txtDateOfBirth" ID="txtDateOfBirth_CalendarExtender" PopupButtonID="stxtDateOfBirth" Format="yyyy-MM-dd"></cc1:CalendarExtender>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4 has-feedback">
                                        ...
                                        <cc1:CalendarExtender runat="server" BehaviorID="txtDateOfIssue_CalendarExtender" TargetControlID="txtDateOfIssue" ID="txtDateOfIssue_CalendarExtender" PopupButtonID="sDateOfIssue" Format="yyyy-MM-dd"></cc1:CalendarExtender>
                                    </div>
                                    ...
                                    <div class="col-md-3 has-feedback">
                                        ...
                                        <cc1:CalendarExtender runat="server" BehaviorID="txtExpiryDate_CalendarExtender" TargetControlID="txtExpiryDate" ID="txtExpiryDate_CalendarExtender" PopupButtonID="stxtExpiryDate" Format="yyyy-MM-dd"></cc1:CalendarExtender>
                                    </div>
                                </div>
