...
let getCountStatsInTable = function (serial, elmClass, value, count, id, opdCount, oRCount, glassesCount) {
   ...
   /* content += `<table class="table">`;
    ...
    content += `<tbody>`;*/
    content += `<tr>`;
    content += `<th class="text-center d-none d-sm-block" scope="row">${serial}</th>`;
    content += `<td class="text-center" data-toggle="tooltip" title="عام الخطة  ${value}">${value}</td>`;
    content += `<td class="text-center" data-toggle="tooltip" title="عدد المخيمات لعام  ${value}">${count}</td>`;
    content += `<td class="text-center" data-toggle="tooltip" title="عدد مراجعي العيادات  ${value}">${opdCount}</td>`;
    content += `<td class="text-center" data-toggle="tooltip" title="عدد مراجعي العمليات  ${value}">${oRCount}</td>`;
    content += `<td class="text-center" data-toggle="tooltip" title="عدد مراجعي النظارات  ${value}">${glassesCount}</td>`;
    /*
    card += '<li class="list-group-item"  data-dataid=' + id + '> <strong > ' + serial + ' </strong> ' + ' - ' + value;
    card += '<span data-toggle="tooltip" title="عدد المخيمات في  ' + value + '" class="badge badge-pill badge-info">' + count + '</span>';
    card += '<span data-toggle="tooltip" title="عدد مراجعي العيادات  ' + value + '" class="badge badge-pill badge-primary tab-number text-center">' + opdCount + '</span>';
