<%@ Page Title="" Language="C#" MasterPageFile="~/Master/WideAdmin.Master" AutoEventWireup="true" CodeBehind="frmCampEquipments.aspx.cs" Inherits="Basar.PreparationForm.frmCampEquipments" %>
        ...
        <asp:UpdatePanel ID="upMain" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <asp:GridView ID="gvEquipment" runat="server" AutoGenerateColumns="False" GridLines="Both" Width="100%" BorderStyle="Solid" CaptionAlign="Top" HorizontalAlign="Center" BorderColor="Black" BorderWidth="3px" CssClass="gridview_mh">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField ControlStyle-Width="90%" ItemStyle-Width="15%" ItemStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle">
                                        <HeaderTemplate>
                                            العدد المطلوب
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <asp:Label ID="lblEquipmentRequiredNumber" runat="server" Text='<%# Bind("EquipmentRequiredNumber") %>' CssClass="control-label">  </asp:Label>
                                    ...
                                    <asp:TemplateField ControlStyle-Width="90%" ItemStyle-Width="15%">
                                        ...
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtEquipmentNumber" runat="server" placeholder="العدد الحالي" MaxLength="20" CssClass="control-label">  </asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField ControlStyle-Width="90%" ItemStyle-Width="35%">
                                        <HeaderTemplate>
                                            ملاحظات
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtRemark" runat="server" placeholder="ملاحظات" MaxLength="200" CssClass="control-label" TextMode="MultiLine">  </asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
