    ...
    const app = {
        ...
        add: () => {
            const obj = {
                ...
                yearStatus: true /*cbYearStatus.is(":checked") == true
        ...
        getRow: () => {
            ...
            app.shared.getRowBydblClick(data => {
                ...
                app.shared.delay(10).then(() => {
                    ...
                    data.YearStatus === true ? app.cbYearStatus.setAttribute('checked', true) :
                        app.cbYearStatus.setAttribute('checked', false)
